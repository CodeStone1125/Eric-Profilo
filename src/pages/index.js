...
export default function Home() {
  return (
    <>
      <Head>
        <title>Eric Chu | Home</title>
        <meta name="description" content="Eric Chu Portfolio" />
      </Head>
      <TransitionEffect />
        ...
        <layout className="pt-0 md:p-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              <AnimatedText
                text="The Best Performance Improvement is Turn Non-work into Work."
                className="!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl sm:pt-2"
              />
            
              {/* <AnimatedText
                text="Software and cathedrals are much the same "
                className="!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl sm:pt-2"
              />
              <AnimatedText
                text="– first we build them, then we pray."
                className="!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl sm:pt-2"
              /> */}
              <p className="my-4 text-base  md:text-sm sm:text-xs">
              I am actively seeking a software engineering position. Please don't hesitate to click the 'Contact' button if you're interested in my background.
              <br /><br />BTW, this is my profilo where I showcase my projects and learning notes.
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                <Link
                  href="mailto:williechu1125@gmail.com"
                  target="_blank"
